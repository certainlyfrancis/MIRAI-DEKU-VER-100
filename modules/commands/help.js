...
const first = numberOfOnePage * page - numberOfOnePage;
    ...
    const siu = `『 ᴄᴏᴍᴍᴀɴᴅs ʟɪsᴛ | ${global.config.BOTNAME}』\nᴘᴀɢᴇ 『${page}/${Math.ceil(arrayInfo.length/numberOfOnePage)}』`;
 ...
 const text = `━━━━━━━━━━━━━━━━\n╰┈➤${global.config.BOTNAME} | ᴘʀᴏᴊᴇᴄᴛ ᴅᴇᴋᴜ \n╰┈➤Dev:\nwww.facebook.com/100072565756983`;
    var link = [
