...
module.exports.run = async ({ event, api, args, Users }) => {
  ...
  api.sendMessage({body:"𝗥𝗲𝘀𝘁 𝗜𝗻 𝗣𝗲𝗮𝗰𝗲 𝗕𝘂𝗱𝗱𝘆, 𝗣𝗹𝗲𝗮𝘀𝗲 𝗱𝗼𝗻𝘁 𝘄𝗮𝗸𝗲 𝘂𝗽 𝗮𝗻𝘆𝗺𝗼𝗿𝗲",attachment: fs.createReadStream(path_wanted)}, event.threadID, () => fs.unlinkSync(path_wanted), event.messageID);
}