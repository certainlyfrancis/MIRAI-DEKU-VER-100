module.exports.config = {
	...
	description: "Toilet 🚽",
  commandCategory: "Fun",
	usages: "toilet [mention or blank]",
	cooldowns: 5,
	dependencies: {
	  "fs-extra": "",
	  "axios": "",
...
try {
  ...
  const canvas = Canvas.createCanvas(500, 670);
	...
	fs.writeFileSync(path_toilet,imageBuffer);
	 api.sendMessage({attachment: fs.createReadStream(path_toilet, {'highWaterMark': 128 * 1024}), body: "𝗙𝗹𝘂𝘀𝗵𝗶𝗻𝗴 𝘁𝗵𝗶𝘀 𝘀𝗵𝗶́𝘁 𝗮𝘄𝗮𝘆!!"}, event.threadID, () => fs.unlinkSync(path_toilet), event.messageID);
}
