...
try {
  ...
  const canvas = Canvas.createCanvas(960, 634);
	...
	fs.writeFileSync(path_toilet,imageBuffer);
	 api.sendMessage({attachment: fs.createReadStream(path_toilet, {'highWaterMark': 128 * 1024}), body: "𝗥𝗲𝘀𝘁 𝗶𝗻 𝗽𝗲𝗮𝗰𝗲 𝗯𝘂𝗱𝗱𝘆 𝗜 𝘄𝗼𝗻𝘁 𝗻𝗲𝘃𝗲𝗿 𝗳𝗼𝗿𝗴𝗲𝘁 𝘆𝗼𝘂"}, event.threadID, () => fs.unlinkSync(path_toilet), event.messageID);
}
